...
var Agenda ={
 ...
 renderSite: function (site) {
   ...
   '<p> Latitud: : lactitud: <br> longitud : :longitud: </br> Descripcion: :descripcion:</p>'+
   '<a href="#!" class="secondary-conten"> <i class="material-icons">grade</i></a>'+
   '</li>';
